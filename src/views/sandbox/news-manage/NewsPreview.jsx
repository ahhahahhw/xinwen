        ...
        <div>
            {
                newsInfo && <div>
                    <PageHeader
                        ...
                        subTitle={newsInfo.category.title}//分类
                    >
                        <Descriptions size="small" column={3}>
                            <Descriptions.Item label="创建者">{newsInfo.author}</Descriptions.Item>
                            <Descriptions.Item label="创建时间">{
                                monment(newsInfo.createTime).format("YYYY/MM/DD HH:mm:ss")}
                            </Descriptions.Item>
                            ...
                            {/* 通过auditState返回的值显示不同审核状态 */}
                            <Descriptions.Item label="审核状态">
                                <span style={{ color: colorList[newsInfo.auditState] }}>{
                                    auditList[newsInfo.auditState]}</span>
                            </Descriptions.Item>

                            {/* 通过publishState返回的值显示不同发布状态 */}
